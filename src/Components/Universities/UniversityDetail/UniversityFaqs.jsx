      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-6">
            ...
            <div className="hidden lg:block p-5 rounded-2xl bg-gradient-to-br from-[#002147] to-[#0B2545] text-white shadow-lg space-y-3.5 border border-slate-700/60 mt-6">
              <div className="flex items-center gap-3">
          ...
          <div className="lg:col-span-7 space-y-3.5">
            ...
            <div className="block lg:hidden p-5 rounded-2xl bg-gradient-to-br from-[#002147] to-[#0B2545] text-white shadow-lg space-y-3.5 border border-slate-700/60 mt-6">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#59c28a]/20 flex items-center justify-center text-[#59c28a] border border-[#59c28a]/40 shrink-0">
                  <PhoneCall className="w-4 h-4" />
                </div>
